...
class TrainerHeaderView: UIView {
    ...
    var viewModel: TrainerViewModel? {
        didSet {
            ...
            userNamesLabel.text = viewModel.trainerFullName
            usernameLabel.text = viewModel.trainerUsername
            ...
            guard let images = viewModel.traienr.value.images, images.count > 0 else {
